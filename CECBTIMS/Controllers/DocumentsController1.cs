...
{
    public class DocumentsController1 : Controller
    {
        ...
        public async Task<ActionResult> test()
        {
            ...
            */
            ...
            var destinationFile = Server.MapPath("~/Storage/" + destinationFileName);
            /**
            ...
            using (var wordDoc = WordprocessingDocument.Open(destinationFile, true))
            {
                ...
                //find bookmark
                var myBookmark = FindBookMark(mainPart, "table");

                if (bookmarks == null)
                {
                    return Content("No bookmark Found");
                }
